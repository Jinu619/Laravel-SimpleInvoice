...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Audiowide&effect=neon|outline|fire|emboss|shadow-multiple">
    <!-- CSS only -->
...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="box container-fluid">
    <a class="navbar-brand" href="#"><i class="far fa-user-circle"></i>&nbsp;<font class="font-effect-fire">{{auth()->user()->name}}</font></a>
